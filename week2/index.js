...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21); // true，相乘時 javascript 會自動轉型把l轉為 8，3 * 8 為 24，24 > 21 為 true
...
const gymCoach = {
  coachWang: {
    ...
    profile: {
      title: '',
      experiences: 5,
      description: '專精於提升學員的肌力與減脂，適合希望快速達成體能目標的學員。'
    },
    newStudentsAllowed: false
  },
  coachLee: {
    expertise: ['瑜伽', '體態雕塑'],
    courses: [
    ...
    profile: {
      title: '瑜伽大師',
      experiences: 10,
      description: '擅長幫助學員雕塑完美體態，適合希望改善姿態與柔軟度的學員'
    },
    newStudentsAllowed: false
  }
};
